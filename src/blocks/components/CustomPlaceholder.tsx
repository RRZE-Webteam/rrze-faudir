    ...
    <Placeholder label={__("Setup your FAUdir Block", "rrze-faudir")}>
      {!isAppearancePanelOpen ? (
        <div style={{ minWidth: "100%" }}>
          ...
          <Spacer paddingTop="1rem" paddingBottom="1.5rem">
            <Button variant="tertiary" onClick={onClickInitialSetupConfirm}>
              {__("Finish initial setup", "rrze-faudir")}
            </Button>

            <Button variant="primary" onClick={onClickChangeAppearance}>
        ...
        <div>
          <Spacer paddingBottom="1.5rem" paddingTop="1rem">
            ...
            <Button variant="tertiary" onClick={onClickChangeData}>
              {__("Back to Data selection", "rrze-faudir")}
            </Button>

            <Button variant="primary" onClick={onClickInitialSetupConfirm}>
              {__("Finish initial setup", "rrze-faudir")}
            </Button>
