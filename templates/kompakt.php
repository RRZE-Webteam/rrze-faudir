        ...
        <?php else: ?>
            <?php if (!empty($person)): ?>
                ...
                <div class="shortcode-contact-kompakt" itemscope itemtype="https://schema.org/Person">
                    ...
                    <?php else: ?>
                        <img src="<?php echo esc_url(plugins_url('rrze-faudir/assets/images/platzhalter-unisex.png', dirname(__FILE__, 2))); ?>" alt="<?php echo esc_attr($fullName . ' Image'); ?>" />
                    <?php endif; ?>
                    <div style="flex-grow: 1;">
                        ...
                        if (in_array('phone', $show_fields) && !in_array('phone', $hide_fields)) {
                            ...
                            // Only display the email if it's not empty
                            if (!empty($phone)) {
                                echo '<p>' . esc_html__('Phone:', 'rrze-faudir') . ' <span itemprop="telephone">' . esc_html($phone) . '</span></p>';
                            }
                        }
                        ?>
                        <?php
